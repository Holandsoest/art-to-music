...
def MakeSong(list):
    ...
    for shape in list:
        if amount_of_drum > 0 and shape.instrument == "drum":
            ...
            midi_drum.addTempo(object_drum, time_drum, 120) # set bpm
            midi_drum.addProgramChange(object_drum, 0, time_drum, 1) # add instrument = shape.instrument = 1
            midi_drum.addNote(object_drum, channel_drum, 60, time_drum, shape.duration, 255) # make a note
        ...
        if amount_of_guitar > 0 and shape.instrument == "guitar":
            ...
            midi_guitar.addTempo(object_guitar, time_guitar, 120) # set bpm
            midi_guitar.addProgramChange(object_guitar, 0, time_guitar, 1) # add instrument = shape.instrument = 1
            midi_guitar.addNote(object_guitar, channel_guitar, 80, time_guitar, shape.duration, 255) # make a note
        ...
        if amount_of_flute > 0 and shape.instrument == "flute":
            ...
            midi_flute.addTempo(object_flute, time_flute, 120) # set bpm
            midi_flute.addProgramChange(object_flute, 0, time_flute, 1) # add instrument = shape.instrument = 1
            midi_flute.addNote(object_flute, channel_flute, 55, time_flute, shape.duration, 255) # make a note
        ...
        if amount_of_violin > 0 and shape.instrument == "violin":
            ...
            midi_violin.addTempo(object_violin, time_violin, 120) # set bpm
            midi_violin.addProgramChange(object_violin, 0, time_violin, 1) # add instrument = shape.instrument = 1
            midi_violin.addNote(object_violin, channel_violin, 88, time_violin, shape.duration, 255) # make a note
        ...
        if amount_of_cello > 0 and shape.instrument == "cello":
            ...
            midi_cello.addTempo(object_cello, time_cello, 120) # set bpm
            midi_cello.addProgramChange(object_cello, 0, time_cello, 1) # add instrument = shape.instrument = 1
            midi_cello.addNote(object_cello, channel_cello, 60, time_cello, shape.duration, 255) # make a note
