...
def MakeSong(list):
    ...
    # make midi file for every instrument
        ...
        for shape in list:
            ...
            if amount_of_instruments -1 == iteration:
                if amount_of_flute == 0:
                    midi_flute.addNote(0, 0, 0, 1, 1, 1) #clear track
                if amount_of_violin == 0:
                    midi_violin.addNote(0, 0, 0, 1, 1, 1) #clear track 
                if amount_of_guitar == 0:
                    midi_guitar.addNote(0, 0, 0, 1, 1, 1) #clear track
                if amount_of_piano == 0:
                    midi_piano.addNote(0, 0, 0, 1, 1, 1) #clear track
                if amount_of_saxophone == 0:
                    midi_saxophone.addNote(0, 0, 0, 1, 1, 1) #clear track
        ...
        midi_piano.addNote(0, 0, 0, 1, 1, 1) #clear track
        midi_saxophone.addNote(0, 0, 0, 1, 1, 1) #clear track
        midi_drum.addNote(0, 0, 0, 1, 1, 1) #clear track
        midi_clap.addNote(0, 0, 0, 1, 1, 1) #clear track
